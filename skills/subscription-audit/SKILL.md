...
- **Account** = the expense account the charge posts to, as the full account name (e.g. `Expenses:Entertainment`).
- **Notes** = short flags like "uncertain match" or "merged from 3 spellings"; leave the cell empty when there's nothing to note.
